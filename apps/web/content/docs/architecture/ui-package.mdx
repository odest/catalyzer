...
<Files>
  <Folder name="packages/ui/src" defaultOpen>
    <Folder name="components" defaultOpen>
      ...
      <Folder name="svgs">
        <File name="Brand and platform SVG icons (biome, nextjs, react, tauri, windows, ...)" />
      </Folder>
    </Folder>
    <Folder name="hooks">
...
| Icon | Source |
|---|---|
| `biome.tsx`, `nextjs.tsx`, `react.tsx`, `rust.tsx`, `tauri.tsx`, `turborepo.tsx` | Tech stack logos |
