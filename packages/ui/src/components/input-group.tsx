...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: This is a custom UI group, not a native form fieldset
    <div
      className={cn(
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/noNoninteractiveElementInteractions: Addon clicks focus the input
    // biome-ignore lint/a11y/useSemanticElements: This is a custom UI group
    <div
